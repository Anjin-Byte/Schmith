...
uv run python builders/build_schemas.py --config configs/procore.toml --adapter openapi
...
uv run python builders/build_serialization.py --config configs/procore.toml --adapter openapi
...
uv run python builders/build_refs.py --config configs/procore.toml
...
uv run python tests/invariants/run_all.py --config configs/procore.toml -v
