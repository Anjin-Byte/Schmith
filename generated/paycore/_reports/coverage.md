...
The following 38 schemas are included as nested types under roots:
...
| 14 | `PagedResultOfHourErrorLog` |
| 15 | `PagedResultOfPayItemErrorLog` |
| 16 | `PagedResultOfPunchErrorLog` |
| 17 | `PayItem` |
| 18 | `PayPeriod` |
| 19 | `PaycorError` |
| 20 | `PaycorRateLimitError` |
| 21 | `Policy` |
| 22 | `PunchProfileWorkLocation` |
| 23 | `ReasonCode` |
...
| 27 | `SchedulingJob` |
| 28 | `SchedulingShift` |
| 29 | `SchedulingShiftBreak` |
| 30 | `SchedulingShiftItem` |
| 31 | `SchedulingShiftResponseItem` |
| 32 | `TimeOffPlan` |
| 33 | `TimeOffRequestDay` |
| 34 | `TimeOffRequestDay2` |
| 35 | `TimeOffRequestsErrorLog` |
| 36 | `TimeOffType` |
| 37 | `TypeBalance` |
| 38 | `UnassignedTimeCardPunch` |
...
| `GETEmployeesSchedulesResponse200` | `schema:anon/3d34c272b33f6c79a137e25e4b69f54396f8b60e` |
...
| `GETEmployeesEmployeeHoursResponse200` | `schema:anon/55dc7353fd994a8d6a4ccfa820a7fb76616b6cd2` |
...
| `GETEmployeesTimeoffplanassignmentResponse200` | `schema:anon/74cf2338a43d073736096fc40344446b0b1ef340` |
...
| `GETEmployeesEmployeePunchesResponse200` | `schema:anon/9af3b2f89c0503483bc23b2f3021cb06f10b1898` |
| `None` | `schema:anon/9b770f93bad302b1cf9ee3b5a6c7b7c82d702d0e` |
| `None` | `schema:anon/9ca4c809e57608a70feee085c89dcf388ee27a59` |
| `GETLegalentitiesTimeOffRequestsErrorLogResponse200` | `schema:anon/9e1d18186f6aefd998ef56d059d69300e305a697` |
...
| `DELETELegalentitiesSchedulingShiftsResponse204` | `schema:anon/bf21a9e8fbc5a3846fb05b4fa0859e0917b2202f` |
