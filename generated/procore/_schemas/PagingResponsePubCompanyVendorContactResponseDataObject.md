# PagingResponsePubCompanyVendorContactResponseDataObject

## PagingResponsePubCompanyVendorContactResponseDataObject
- Role: parent
- Schema Name: PagingResponsePubCompanyVendorContactResponse
- Schema ID: schema:components/PagingResponsePubCompanyVendorContactResponse
...
| `limit` | `int` |
| `total` | `int` |
| `data` | `PubCompanyVendorContactResponse[]` |
...
## PagingOrderDataResponse
- Role: nested
- Parent: PagingResponsePubCompanyVendorContactResponseDataObject
