...
The following 17 schemas are included as nested types under roots:

| # | Schema Name |
|---|-------------|
| 1 | `BaseError` |
| 2 | `CustomFieldFilterRule` |
| 3 | `DatasetField` |
| 4 | `DistributionError` |
| 5 | `DocGenFullWithErrors` |
| 6 | `Error` |
| 7 | `EventActor` |
| 8 | `FragmentFieldsetField` |
| 9 | `GenerationInfo` |
| 10 | `OAuthError` |
| 11 | `Organization` |
| 12 | `OutputFormatPatchRequest` |
| 13 | `ProcessTemplateRestriction` |
| 14 | `RateLimitErrors` |
| 15 | `RequestFormDataFieldValue` |
| 16 | `TemplateRestriction` |
| 17 | `UserSimplified` |
...
| `GETOrganizationsResponse200` | `schema:anon/c33cf55f8516018dfec2345eadb6c3b8a504c947` |
...
| `GETUsersResponse200` | `schema:anon/c8499daacd0b84ab9982b5a6f1c38a7171d8f366` |
